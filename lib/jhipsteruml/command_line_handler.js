...
function handle() {
  return yargs
      .usage('Usage: genie-uml <xmi file> [-options]')
      .option({
        db: {
        ...
        'skip-user-management': {
          describe: 'Tells Genie not to manage the User entity',
          nargs: 0
        },
        'no-fluent-methods': {
      ...
      .strict()
      .version(function() {
        return `The current version of Genie UML is ${require('../../package.json').version}`;
      })
      .alias('version', 'v')
      .wrap(null);
}
